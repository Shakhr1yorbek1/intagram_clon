...
import 'package:intagram_clone/model/post_model.dart';
import 'package:intagram_clone/service/file_service.dart';
import 'package:intagram_clone/service/http_service.dart';
...
class DataService {
  ...
  static Future<List<Post>> loadsomeonePosts(String uid) async {
    List<Post> posts = [];
    var likedPostsData = [];
    var likedPosts = [];
